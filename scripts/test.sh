...
echo "[5/23] timer interrupt check"
make clean
make TIMER_TEST=1
...
echo "[6/23] heap allocator check"
make clean
make HEAP_TEST=1
...
echo "[8/23] keyboard decoder check"
make clean
...
echo "[9/23] virtual memory stack check"
make clean
make VM_TEST=1
run_qemu vm_log.txt
...
echo "[10/23] physical memory manager check"
make clean
make PMM_TEST=1
...
echo "[11/23] virtual memory mapping check"
make clean
make VMM_TEST=1
...
echo "[12/23] page fault handler check"
make clean
make PF_TEST=1
run_qemu pf_log.txt
...
echo "[13/23] nx execute protection check"
make clean
make NX_TEST=1
run_qemu nx_log.txt
...
echo "[15/23] shell line editing check"
make clean
make EDIT_TEST=1
...
echo "[16/23] capability primitives check"
make clean
make CAP_TEST=1
...
echo "[17/23] capability enforcement check"
make clean
...
echo "[18/23] syscall capability gate check"
make clean
make SYSCALL_TEST=1
...
echo "[19/23] syscall deny path check"
make clean
...
echo "[20/23] task scheduler check"
make clean
make TASK_TEST=1
...
echo "[21/23] task capability isolation check"
make clean
...
echo "[22/23] capability generation guard check"
make clean
make CAP_GEN_TEST=1
...
echo "[23/23] user mode launch path check"
make clean
